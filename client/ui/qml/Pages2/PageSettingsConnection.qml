    ...
    ListViewType {
        ...
        delegate: ColumnLayout { // TODO(CyAn84): add DelegateChooser when have migrated to 6.9
            ...
            SwitcherType {
                ...
                text: qsTr("Use Fresh VPN DNS")
                descriptionText: qsTr("If Fresh VPN DNS is installed on the server")
            ...
            LabelWithButtonType {
                ...
                descriptionText: qsTr("When Fresh VPN DNS is not used or installed")
