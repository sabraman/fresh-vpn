...
PageType {
    ...
    QtObject {
        ...
        readonly property string title: qsTr("Check the server for previously installed Fresh VPN services")
    ...
    QtObject {
        ...
        property bool isVisible: root.isServerWithWriteAccess
        readonly property string title: qsTr("Clear server from Fresh VPN software")
        readonly property string description: ""
        readonly property var tColor: AmneziaStyle.color.vibrantRed
        readonly property var clickedHandler: function() {
            var headerText = qsTr("Do you want to clear server from Fresh VPN software?")
            ...
            var yesButtonFunction = function() {
                if (ServersUiController.isDefaultServerCurrentlyProcessed() && ConnectionController.isConnected) {
                    PageController.showNotificationMessage(qsTr("Cannot clear server from Fresh VPN software during active connection"))
                } else {
