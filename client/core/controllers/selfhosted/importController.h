...
public:
    ...
    ErrorCode importSubscription(const QString &subscriptionUrl);
...
private:
    ...
    ErrorCode addServersFromSubscriptionBody(const QByteArray &body);
    ...
    QNetworkReply *m_subscriptionReply = nullptr;
    QTimer *m_subscriptionTimer = nullptr;
    bool m_subscriptionTimedOut = false;
    bool m_subscriptionSizeExceeded = false;
};
